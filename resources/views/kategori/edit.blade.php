            ...
            <div class="card-body">
                <form action="{{ route('kategori.update', $kategori->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('deskripsi_kategori') is-invalid @enderror" id="deskripsi_kategori" name="deskripsi_kategori" rows="3">{{ old('deskripsi_kategori', $kategori->deskripsi_kategori) }}</textarea>

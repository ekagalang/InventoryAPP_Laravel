...
@section('title', 'Edit Unit - ' . $unit->nama_unit)
            ...
            <div class="card-body">
                <form action="{{ route('unit.update', $unit->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('singkatan_unit') is-invalid @enderror" id="singkatan_unit" name="singkatan_unit" value="{{ old('singkatan_unit', $unit->singkatan_unit) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('deskripsi_unit') is-invalid @enderror" id="deskripsi_unit" name="deskripsi_unit" rows="3">{{ old('deskripsi_unit', $unit->deskripsi_unit) }}</textarea>
